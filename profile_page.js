       ...
       // Tab Switching
        ...
        document.getElementById('editPhotoPreview').src = tempPhotoUrl;
        ...
        const currentPreview = document.getElementById('editPhotoPreview').src;
        if (!currentPreview.includes('ui-avatars.com')) {
        ...
        function handlePhotoUpload(event) {
            ...
            if (file) {
                ...
                reader.onerror = function() {
                    ...
                    document.getElementById('editPhotoPreview').style.opacity = '1';
                };
        ...
        function savePhotoChanges() {
            if (tempPhotoUrl) {
                document.getElementById('profileImage').src = tempPhotoUrl;
